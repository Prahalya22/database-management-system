...
//     if($num==1)
//     {
        $reg = " insert into guidetable (uname,fname,lname,mail,address,country,phone,experince,specialization,qualification,description) values('$uname','$fname','$lname','$mail','$address','$country','$phone','$experince','$specialization','$qualification','$subject')";
