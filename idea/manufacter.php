...
<head>
    ...
    <link rel="stylesheet" href="manufacter.css">
    <style>
      .add_button {
    ...
    <div class="container">
        ...
        <div id="main" >
              ...
              <div class="fixed-top">
                <div class="divc">
                <nav>
                <h3 width="100" height="150" style="margin-left:2.5em;" text-align="center" ><h3 style="padding-right: 10px;"></h3>
                <img src="logo_dbms_f-removebg-preview.png" width="50" height="50" alt="" style="padding-top: 8px;">
                VISION <ul>
                      <li><a href="manuform.html">APPLY</a></li>
      ...
      <img src="h2.jpeg" height="90%" width="100%" ><h1 style="text-align: center;padding:20px;color:rgb(32, 32, 78)"><u>MANUFACTURE SECTOR</u></h1>
       
     
<h1 style="padding-left:20px;"> ITEMS </h1> <br>
...
<div class="cardlist" >
 ...
 <div class="card" style="margin:5px 355px">
   ...
   <h2 class="item_name" style="color: rgb(33, 4, 71);"><?php echo $rows['M_ID'];?>.
   <?php echo $rows['fname'];?>
				<?php echo $rows['lname'];?><br><br>
				<?php echo $rows['mail'];?><br>
        Item : <?php echo $rows['iname'];?><br>
