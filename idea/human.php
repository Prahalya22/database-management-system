              ...
              <div class="fixed-top">
                ...
                <img src="logo_dbms_f-removebg-preview.png" width="50" height="50" alt="" style="padding-top: 8px;">
                    VISION <ul>
                        ...
                        <li><a href="humform.html">APPLY AS EMPLOYEE</a></li>
                        <li><a href="guideform.html">APPLY AS GUIDE</a></li>
                     </ul>
                </h3>
              </nav>
            </div>
      </div>
      <img src="h3.jpg" height="90%" width="100%" ><h1 style="text-align: center;padding:20px;color:rgb(32, 32, 78)"><u>HUMAN SECTOR</u></h1>
       
     
      <h1 style="padding-left:20px;">EMPLOYEE</h1> 
...
<div class="card" style="margin:5px 355px">
  ...
  <h2 class="item_name" style="color: rgb(33, 4, 71);"><?php echo $rows['EMP_ID'];?>.
  <?php echo $rows['fname'];?>
       <?php echo $rows['lname'];?><br><br>
       <?php echo $rows['mail'];?><br><br>
       Experience : <?php echo $rows['experince'];?><br>
				Specialization : <?php echo $rows['specialization'];?><br>
				Qualification : <?php echo $rows['qualification'];?>
...
?>
      ...
      <br><br>
      <h1 style="padding-left:20px;">GUIDE</h1> 
      <?php // LOOP TILL END OF DATA
				while($rows=$result->fetch_assoc())
				{
			?>
...
<div class="card" style="margin:5px 355px">
  ...
  <h2 class="item_name" style="color: rgb(33, 4, 71);"><?php echo $rows['G_ID'];?>.
  <?php echo $rows['fname'];?>
       <?php echo $rows['lname'];?><br><br>
       <?php echo $rows['mail'];?><br><br>
       Experience : <?php echo $rows['experince'];?><br>
